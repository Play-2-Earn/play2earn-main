    ...
    <Header />
      <div className="flex items-center justify-center min-h-screen bg-blue-200 p-4 text-justify rounded-lg">
        <div className="bg-white text-gray-800 p-6 shadow-lg max-w-3xl w-full mx-auto ">
          ...
          <p className="mb-6">
            Welcome to Play2Earn. At Play2Earn ("us," "our," or "we"), your
          ...
          <ul className="list-disc list-inside ml-4 mb-4">
            ...
            <li>
              ...
              you visit our website. For more details on the cookies we use,
              please refer to Section 8 of this Policy.
            </li>
          </ul>
          <h3 className="font-semibold text-blue-500 mt-4 mb-2">
          ...
          <ul className="list-disc list-inside ml-4 mb-4">
            ...
            <li>
              ...
              public key, email, and last login date to our service platform.
            </li>
          </ul>
          <h3 className="font-semibold text-blue-500 mt-4 mb-2">
          ...
          <ul className="list-disc list-inside ml-4 mb-4">
            <li>
              ...
              <ul className="list-disc list-inside ml-4 mt-2">
                <li>
                  Send you important updates and announcements related to our
                  services and website.
                </li>
                <li>Respond to your requests or inquiries.</li>
                <li>
                  Send you offers, surveys, and other marketing content (with an
          ...
          <p className="mb-4">
            <strong>Promotional Participation:</strong> When you participate in
            our promotional games (e.g., sweepstakes, giveaways, contests)
            requiring additional personal information, you will be explicitly
            requested to provide it. The personal data typically includes your
            full name, email address, and information about the purchased
            subscription plan. You can refuse to provide such information and
            cease participation at any time. We may share this data with third
            parties assisting in organizing and coordinating the promotional
            games. Review the specific terms and conditions of each promotional
            game you participate in, as they may contain additional information
            about data processing. If these terms conflict with this Privacy
            Policy, the promotional game terms will prevail.
          </p>
          <h3 className="font-semibold text-blue-500 mt-4 mb-2">
            2.6 Social Networks Data
          </h3>
          <p className="mb-4">
            <strong>Account Data:</strong> For managing and administering our
          ...
          <p className="mb-4">
            To provide our services effectively, we may use third-party service
            providers (data processors) to process your personal data. These
            service providers' access to your personal data is limited to the
            purposes of data storage and retrieval. We share only the personal
            data necessary for them to provide our services, support, or website
            access. They do not use or access your personal information for any
            other purposes
          </p>
          <h3 className="font-semibold text-blue-500 mt-4 mb-2">
          ...
          <p className="mb-4">
            At Play2Earn, we are committed to retaining your personal data only
            for as long as necessary to fulfill the purposes for which it was
            collected, as outlined in this Policy. We will retain your personal
            data to:
            <ul className="list-disc list-inside ml-4 mb-4">
              <li>
          ...
          <p className="mb-4">
            ...
            <ul className="list-disc list-inside ml-4 mb-4">
              ...
              <li>
                <strong>Amend:</strong> You have the right to request updates or
                corrections to any inaccurate or incomplete personal information
                we hold about you.
              </li>
              <li>
              ...
              <li>
                ...
                about the personal data we collect about you and how it is
                processed.
              </li>
              <li>
                <strong>Limit Processing:</strong> You have the right to request
                limitations on the processing of your personal data in certain
              ...
              <li>
                <strong>Withdraw Consent:</strong> If we process your personal
                data based on your consent, you have the right to withdraw your
          ...
          <p className="mb-4">
            ...
            robust measures to protect it. Our security practices include:
            <ul className="list-disc list-inside ml-4 mb-4">
              <li>
                <strong>Encryption and Firewalls:</strong> We use encryption,
                secure servers, and firewalls to safeguard your data.
              </li>
              <li>
                <strong>Regular Updates:</strong> We continually update and test
          ...
          <p className="mb-4">
            When using the Play2Earn platform, you may encounter links or
            opportunities to access third-party applications or participate in
            surveys provided by external entities. Please be aware that:
            <ul className="list-disc list-inside ml-4 mb-4">
              <li>
                <strong>Separate Privacy Practices:</strong> The information
                collected by these third parties is not covered by our Privacy
                Policy and may not be subject to the same security measures as
                your data submitted directly to us.
              </li>
              <li>
          ...
          <p className="mb-4">
            Should you have any data protection related inquiries or questions
            regarding the Privacy Policy, you may contact us at{" "}
            <a
              href="mailto:privacy@play2earn.io"
              className="text-blue-600 underline"
            >
