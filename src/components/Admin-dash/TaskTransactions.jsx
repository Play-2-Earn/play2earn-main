...
function TaskTransactions() {
    ...
    const handleSaveEdit = async () => {
        try {
            await axios.put(`http://localhost:5001/api/transactions/${editingTransaction.id}`, editingTransaction);
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`http://localhost:5001/api/transactions/${deleteConfirmation}`);
