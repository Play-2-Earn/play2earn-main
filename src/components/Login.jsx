...
const LoginPopup = ({ isOpen, onClose, innSignUpLink, innForgetPasswordLink, userLoginStatusDone }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white backdrop-blur-lg rounded-[20px] shadow-lg p-6 max-w-sm w-full border border-gray-300">
        ...
        <div className="flex justify-center mb-4">
          <button
            onClick={toggleRole}
            className={`px-4 py-2 rounded-lg font-semibold focus:outline-none transition ${role === 'Admin' ? 'bg-green-500 text-white' : 'bg-blue-500 text-white'
              }`}
          >
