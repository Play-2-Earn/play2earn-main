                                ...
                                <div className="w-full lg:w-4/5 pl-4 lg:mx-auto flex flex-col lg:flex-row justify-center lg:justify-between">
                                    ...
                                    <div className="w-full lg:w-1/4 mb-6 lg:mr-10 lg:mb-0">
                                        ...
                                        <div className="border-solid border-2 border-gray-300 rounded-xl mb-6 p-4">
                                            ...
                                            <p className="text-sm text-left mt-6">Name: {userData.firstName} {userData.lastName}</p>
                                            <p className="text-sm text-left mt-6">Email: {userData.email}</p>
                                            <p className="text-sm text-left mt-6">Current level: {userData.level}</p>
                                            <p className="text-sm text-left mt-6">Participating-task: {userData.task_participated}</p>
                                        </div>

                                        {/* Earning Overview */}
                                        <div className="border-solid border-2 border-gray-300 rounded-xl mb-6 p-4">
                                            <h3 className="text-xl text-center">Earning Overview</h3>
                                            <p className="text-sm text-left mt-6">Total-earned: {userData.total_rewards}</p>
                                        ...
                                        <div className="border-solid border-2 border-gray-300 rounded-xl p-4">
                                            ...
                                            <p className="text-sm text-left mt-6">Task Completed: {userData.tasks_completed}</p>
                                            <p className="text-sm text-left mt-3">Ai model improved: {userData.aiModelImproved}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full lg:w-3/4">
                                        ...
                                        <div className="border-solid border-2 border-gray-300 rounded-xl mb-6 p-4">
                                            ...
                                            <a className="cursor-pointer px-4 py-2 text-white rounded-3xl bg-blue-500 hover:bg-blue-700" onClick={showMoreReset}>
