  ...
  return (
    <div>
      {loading && (
        <div className="loading-overlay">
          ...
          <p className="loading-text">
            Please wait while our AI fetches the best candidates...
          </p>
        </div>
      )}
      <Header />
      ...
      >
        ...
        >
          <h2 style={{ textAlign: "center", color: "#1f0775" }}>
            Project Description
          </h2>
          <form onSubmit={handleSubmit}>
            ...
            >
              <div style={{ flex: "1 1 48%", marginBottom: "20px" }}>
                ...
                <div style={{ marginBottom: "20px", paddingRight: "50px" }}>
                  <label>
                    What are the specific objectives to achieve the goal?
                  </label>
                  <input
                    type="text"
                    name="objectives"
          ...
          {topCVs.length > 0 && (
            <div>
              ...
              <ul>
                {topCVs.map((cv, index) => (
                  <li key={index}>
                    <strong>{cv.file_name}</strong> - Score:{" "}
                    {cv.context_score.toFixed(2)}
                  </li>
                ))}
              </ul>
            </div>
