                  ...
                  <div id="uploadCV" className="tab-content active">
                    ...
                    >
                      ...
                      <p className="upload-info">
                        We accept DOCX, PDF, TXT files up to 2MB
                        <br />
                ...
                <div className="preview-content">
                  ...
                  {activeTab === "createCV" && (
                    <>
                      ...
                      <p>
                        <strong>Years of Experience:</strong> {formData.yoe}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Job Description:</strong> {formData.jd}
                      </p>
                      <p>
                        <strong>Educational Experience:</strong> {formData.ee}
                      </p>
                      <p>
                        <strong>Work Experience:</strong> {formData.we}
                      </p>
                    </>
                  )}
                </div>
