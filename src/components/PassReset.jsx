...
const PasswordReset = ({ isOpen, onClose }) => {
    ...
    const handlePassReset = async (e) => {
        e.preventDefault()
        try {
            const response = await axios.post('http://localhost:5002/api/users/passwordSet', { otp, newPassword })
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white backdrop-blur-lg rounded-[20px] shadow-lg p-6 max-w-sm w-full border border-gray-300">
                ...
                <form onSubmit={handlePassReset}>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font mb-2" htmlFor="otp">OTP</label>
                        <input
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font mb-2" htmlFor="newPassword">Password</label>
                        <input
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font mb-2" htmlFor="re_type_password">Retype Password</label>
                        <input
